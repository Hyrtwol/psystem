...
const
      ...
      {elide maxstr      = 16777215; noelide}
      maxstr     =  65536;   { maximum size of addressing for program/var }
      ...
      maxfil      = 16{100}; { maximum number of general (temp) files }
...
procedure load;
   ...
   procedure errorl(errmsg: beta); (*error in loading*)
   begin writeln;
      writeln('*** Program load error: [', iline:1, '] ', errmsg);
      goto 1
   end; (*errorl*)
            ...
            begin if eof(prd) then errorl('unexpected eof on input  ');
                  ...
                  case ch of
                       ...
                       'l': begin
                               read(prd,x);
                               getnxt;
                               skpspc; {added a space in front of '=' to please delphi and fpc [tlc]}
